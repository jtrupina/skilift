...
//Class that extends ControlExtension and
//Parrent Class of SmartWatchController that is used for starting and closing smartwatch controls/ui-s
public class SmartWatchControllerBase extends ControlExtension {
	 ...
	 */
	public SmartWatchControllerBase(final Context context,
	...
	// Method that start a new control. Any currently running control will be
	// stopped.
	...
	// Method that close a current Control
